class PipeattributesController < BaseController
  ...
  def create
    ...
    if @pipeattribute.save
      ...
      redirect_to edit_pipeline_path(@pipeline), notice: "Pipeattribute was successfully created."
    else
  ...
  def update
    if @pipeattribute.update(pipeattribute_params)
      redirect_to edit_pipeline_path(@pipeline), notice: "Pipeattribute was successfully updated."
    else
