...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference("Calendar.count") do
      post calendars_url, params: { calendar: { name: @calendar.name, organization_id: @calendar.organization_id } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { name: @calendar.name, organization_id: @calendar.organization_id } }
